      ...
      >
        {features.map((f) => (
          <motion.div
            ...
            className="group rounded-2xl bg-glass p-8 flex flex-col transition-all cursor-default border border-border/40 hover:border-primary/20 bg-background/50 backdrop-blur-sm"
          >
            <f.icon className={`w-10 h-10 ${f.color} mb-5`} />
