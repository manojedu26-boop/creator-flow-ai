    ...
    <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-[200]">
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* HEADER */}
            <div className="p-5 md:p-6 bg-primary/5 border-b border-border/20 flex items-center justify-between">
               ...
               <button onClick={() => setIsOpen(false)} className="p-2 hover:bg-muted rounded-full transition-all">
                  <X className="w-5 h-5 flex md:hidden" />
            ...
            {/* QUICK PROMPTS & INPUT */}
            <div className="p-5 md:p-6 space-y-4 bg-muted/5 border-t border-border/20">
