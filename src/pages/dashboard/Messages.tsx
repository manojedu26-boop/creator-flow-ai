...
import { 
  ...
  Smile, AttachmentIcon, Paperclip
} from "lucide-react";
...
export const Messages = () => {
  ...
  return (
    <PageTransition>
      <div className="flex h-[calc(100vh-140px)] -mx-8 -my-6 overflow-hidden bg-background/50 relative">
        {/* BACKGROUND ACCENTS */}
        ...
        {/* LEFT — INBOX LIST */}
        <div className="w-[400px] border-r border-border/10 flex flex-col h-full bg-card/20 backdrop-blur-3xl z-10">
           <div className="p-8 space-y-6">
              ...
              <div className="flex gap-1 bg-muted/10 p-1.5 rounded-2xl border border-border/10">
        ...
        <div className="flex-1 flex flex-col h-full bg-transparent relative overflow-hidden backdrop-blur-md">
           {/* HEADER */}
           <div className="h-20 border-b border-border/10 bg-card/30 backdrop-blur-3xl flex items-center px-10 justify-between z-10">
              <div className="flex items-center gap-4">
                 <div className="w-10 h-10 rounded-xl bg-zinc-900 flex items-center justify-center text-white font-black">N</div>
                 <div>
              ...
              <div className="flex items-center gap-4">
                 <button className="h-10 px-5 rounded-xl border border-border/40 hover:bg-muted/30 transition-all text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                    <HistoryIcon className="w-4 h-4" /> Deal History
                 </button>
           ...
           <div className="bg-primary/5 py-4 px-10 flex items-center gap-6 border-b border-border/10 overflow-x-auto no-scrollbar">
              ...
              <div className="flex gap-2">
                 {[
                   ...
                   { label: 'Improve Contract', icon: ShieldCheck },
                   { label: 'Price benchmark', icon: IndianRupee },
                   { label: 'Next Steps', icon: ChevronRight },
                 ].map(tool => (
                   <button 
                    key={tool.label}
                    onClick={() => tool.label === 'Suggest Reply' && setShowAiSuggest(true)}
                    className={`h-9 px-5 rounded-xl text-[9px] font-black uppercase tracking-widest flex items-center gap-2 border transition-all whitespace-nowrap ${
           ...
           <div className="flex-1 overflow-y-auto p-12 space-y-10 no-scrollbar relative">
              ...
              <div className="flex items-start gap-4">
                 <div className="w-12 h-12 rounded-2xl bg-zinc-900 border border-border/40 flex items-center justify-center text-white font-black text-lg shadow-xl">N</div>
                 <div className="max-w-[65%] space-y-2">
                    <div className="bg-card/40 backdrop-blur-xl border border-border/40 p-6 rounded-[2.5rem] rounded-tl-none shadow-sm hover:shadow-2xl transition-all group">
              ...
              <div className="flex items-start gap-4 flex-row-reverse">
                 <div className="w-12 h-12 rounded-2xl bg-primary border border-primary/40 flex items-center justify-center text-white text-md font-black uppercase tracking-widest shadow-2xl shadow-primary/30">ME</div>
                 <div className="max-w-[65%] space-y-2 text-right">
                    <div className="bg-primary text-primary-foreground p-6 rounded-[2.5rem] rounded-tr-none shadow-2xl shadow-primary/20">
                       <p className="text-md font-black leading-relaxed">
              ...
              <AnimatePresence>
                 {showAiSuggest && (
                    <motion.div 
                      ...
                      className="p-10 bg-primary/10 border border-primary/20 rounded-[3.5rem] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)] space-y-8 backdrop-blur-2xl relative overflow-hidden ring-1 ring-primary/30"
                    >
                       ...
                       <div className="flex items-center justify-between relative z-10">
                          <div className="flex items-center gap-4">
                             <div className="p-4 bg-primary text-white rounded-2xl shadow-xl shadow-primary/20"><Sparkles className="w-6 h-6" /></div>
                             <div>
                                <h3 className="text-md font-black uppercase tracking-tighter">AI Reply Blueprint</h3>
                                <p className="text-[10px] font-bold text-muted-foreground uppercase opacity-70">Focus: Upselling & Creative Input</p>
                             </div>
                          </div>
                          <button onClick={() => setShowAiSuggest(false)} className="w-10 h-10 rounded-xl hover:bg-rose-500/10 hover:text-rose-500 transition-all flex items-center justify-center"><Trash2 className="w-5 h-5" /></button>
                       </div>
                       <div className="p-8 bg-background/60 border border-white/5 rounded-[2rem] italic text-[16px] font-medium leading-relaxed text-foreground shadow-inner">
                       ...
                       <div className="flex gap-4 relative z-10">
                          <button className="flex-1 h-14 bg-primary text-white rounded-2xl text-[11px] font-black uppercase tracking-widest hover:shadow-2xl hover:shadow-primary/30 active:scale-95 transition-all">Apply Reply</button>
                          <button className="h-14 px-8 bg-background/50 border border-border/40 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-muted transition-all flex items-center gap-2">
           ...
           {/* INPUT AREA */}
           <div className="p-10 bg-card/40 backdrop-blur-3xl border-t border-border/10">
              <div className="max-w-4xl mx-auto flex items-end gap-6 h-22">
                 <div className="flex-1 h-16 bg-background/50 border border-border/40 rounded-[2.5rem] px-10 flex items-center relative overflow-hidden group focus-within:border-primary focus-within:ring-1 focus-within:ring-primary shadow-sm hover:border-primary/50 transition-all">
                    <input 
                      placeholder="Type your world-class message..." 
                      className="w-full bg-transparent focus:outline-none text-sm font-bold placeholder:text-muted-foreground/30" 
                    />
                    <div className="flex items-center gap-6 text-muted-foreground/50">
                       <Paperclip className="w-5 h-5 hover:text-primary transition-colors cursor-pointer" />
                       <Smile className="w-5 h-5 hover:text-primary transition-colors cursor-pointer" />
                    </div>
                 </div>
                 <button className="h-16 w-24 bg-primary text-white rounded-[2.5rem] shadow-3xl shadow-primary/20 hover:shadow-primary/40 hover:scale-105 active:scale-95 flex items-center justify-center transition-all group relative overflow-hidden">
