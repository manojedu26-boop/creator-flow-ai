  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
         {[
           { label: 'Revenue This Month', value: '₹ 1,57,000', change: '+24%', icon: IndianRupee, color: 'text-emerald-500' },
           { label: 'Outstanding Invoices', value: '₹ 45,000', count: '3 Pending', icon: Clock, color: 'text-amber-500', clickable: true },
           { label: 'Revenue This Year', value: '₹ 8,42,000', change: '+12%', icon: TrendingUp, color: 'text-indigo-500' },
           { label: 'Projected (30 Days)', value: '₹ 1,85,000', subtitle: 'AI Estimate', icon: Sparkles, color: 'text-primary' },
         ].map((stat, i) => (
           <motion.div 
             ...
             key={stat.label} 
             className={`bg-card border border-border/40 p-6 rounded-[2rem] shadow-sm hover:shadow-xl transition-all group ${stat.clickable ? 'cursor-pointer hover:border-primary/40' : ''}`}
           >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         <div className="lg:col-span-2 bg-card border border-border/40 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="h-[400px] w-full relative z-10">
               <ResponsiveContainer width="100%" height="100%">
                  ...
                  />
                     ...
                     <Bar dataKey="brandDeals" stackId="a" fill="hsl(var(--primary))" radius={[0, 0, 0, 0]} name="Brand Deals" />
                     <Bar dataKey="affiliate" stackId="a" fill="#3b82f6" name="Affiliate" />
                     <Bar dataKey="products" stackId="a" fill="#10b981" name="Products" />
                     <Bar dataKey="other" stackId="a" fill="#f59e0b" radius={[10, 10, 0, 0]} name="Other" />
                  </BarChart>
               </ResponsiveContainer>
            </div>
         </div>
         ...
         <div className="bg-card border border-border/40 rounded-[2.5rem] p-8 shadow-2xl space-y-8 flex flex-col">
      ...
      <div className="bg-card border border-border/40 rounded-[2.5rem] shadow-2xl overflow-hidden">
         <div className="p-8 border-b border-border/30 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-muted/10">
            ...
            <button 
              ...
              className="h-12 px-8 bg-black text-white rounded-2xl text-[11px] font-black uppercase tracking-widest flex items-center gap-3 hover:scale-105 transition-all shadow-xl"
            >
      ...
      <AnimatePresence>
         {showInvoiceDrawer && (
            <div className="fixed inset-0 z-[110] flex justify-end">
               ...
               <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }} className="relative w-full max-w-xl bg-card border-l border-border/40 shadow-2xl h-screen flex flex-col p-10 overflow-y-auto">
                  ...
                  <div className="space-y-8">
                     ...
                     <div className="grid grid-cols-2 gap-4 pt-10">
                        ...
                        <button className="h-16 rounded-[1.5rem] bg-primary text-primary-foreground font-black uppercase tracking-widest text-xs shadow-xl hover:shadow-2xl transition-all">Send Invoice</button>
                     </div>
                  </div>
               </motion.div>
            </div>
